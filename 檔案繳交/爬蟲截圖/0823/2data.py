...
import pandas as pd
df1 = pd.DataFrame(columns=["store_name","create_time","phone_number","address","total_score","business_hour","url","is_appointed_store","is_unknown_store"])
...
for index, row in enumerate(link):
    ...
    try :
        btn1 = driver.find_element("xpath", "/html/body/div/div/div/div[2]/main/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[4]")
        print(True)
    except:
        print("沒有電話")
        phone_number = "999"
