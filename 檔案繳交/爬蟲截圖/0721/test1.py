...
url = "https://ifoodie.tw/restaurant/62d5b304873d790c01e402ce-%E6%9F%B3%E5%B7%9E%E8%9E%BA%E8%9E%84%E7%B2%89"
driver.get(url)
time.sleep(1)
...
for x in range(20):
    ...
    for review in reviews:
        ...
        s2 = pd.Series([date_time,star,rev],index=["date","star","reviews"])
